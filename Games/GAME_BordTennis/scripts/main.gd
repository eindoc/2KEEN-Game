...
var life_icon = preload("res://Games/GAME_BordTennis/img/Sprite-0001.png")
...
@onready var game_over_panel = get_node("/root/BordTennis/GameOverPanel")
#@onready var final_score_label = get_parent().get_node("GameOverPanel/PlayAgainButtons/FinalScore")
@onready var final_score_label = get_node("/root/BordTennis/GameOverPanel/PlayAgainButtons/FinalScore")
#@onready var game_over_high_score_label = get_parent().get_node("GameOverPanel/PlayAgainButtons/HighScore")
@onready var game_over_high_score_label = get_node("/root/BordTennis/GameOverPanel/PlayAgainButtons/HighScore")
...
func game_over():
	var game_over_container = get_node("/root/BordTennis/GameOverPanel/GameOvers")
	var labels = game_over_container.get_children()
	for label in labels:
		label.visible = false
	labels[randi() % labels.size()].visible = true
